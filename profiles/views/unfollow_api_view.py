...
class UnfollowProfileAPIView(APIView):
    ...
    @extend_schema(
        ...
        description="Unfollow a user profile",
    )
    ...
    def post(self, request, pk):
        ...
        try:
            FollowService.unfollow(request.user, target_user)
