...
SECRET_KEY = os.getenv("SECRET_KEY", "2kx3c54jyol&o%u0rpg@pbm4mivmncjxqk#-hmx)v#u2sa109!")
...
# Fallback to in-memory channel layer for development (uncomment if Redis is not available)
# CHANNEL_LAYERS = {
#     'default': {
